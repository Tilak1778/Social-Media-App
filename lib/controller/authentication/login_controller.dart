...
import 'package:social_media_app/controller/initial_data/get_all_initial_data.dart';
        ...
        if(!isLoading.value){
          ...
          if(checkEmailValid(emailController.text.trim()) == false){
            ...
            if(mounted){
              ...
              print('tilak loginWithEmail enter');
              ...
              //{
                ...
                print('tilak  '+user.toString());
                if(user != null){
                  isLoading.value = true;

                  /// Check if the user's email is verified
                  // tilak var verified = authRepo.currentUser.value?.emailVerified == false ? 
                  var verified = false ? 
                  ...
                  if(verified == true && mounted){
                    ...
                    dynamic res = await GetAllInitialData(context).getAllConversations();
