              ...
              ValueListenableBuilder(
                ...
                builder: (context, isVerified, child){
                  return AnimatedContainer(
                    ...
                    //tilak child: !isVerified ? const CircularProgressIndicator() : const Icon(FontAwesomeIcons.check)
                    child: true ? const CircularProgressIndicator() : const Icon(FontAwesomeIcons.check)
                  );
                },
              ),
              SizedBox(height: getScreenHeight() * 0.04),
